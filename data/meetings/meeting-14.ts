  ...
  parts: [
    {
      ...
      sections: [
        ...
        },
        {
          type: 'text' as const,
          content:
            'Это тот же маршрут, которым шёл сам курс: сначала визуальный слой (M6 → M7 → M8 → M9 → M10 → M11 → M12), потом research (M3 → M4 → M5). Порядок повторяет реальный процесс редизайна — **сначала смотрим что есть → потом разбираем зачем**.',
        },
        {
