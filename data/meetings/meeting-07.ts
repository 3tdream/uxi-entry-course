    ...
    // =============================================
    {
      ...
      sections: [
...

        {
          ...
          alt: 'Постер «Принципы хорошей типографики»: ключевые элементы, 5 принципов, правила и стили шрифтов',
          caption: 'Шпаргалка: ключевые элементы типографики, 5 принципов, правила вёрстки текста и стили шрифтов — всё на одном листе.',
          maxWidth: 572,
        },
      ...
      quiz: [
        ...
        {
          question: 'Что такое x-height и почему два шрифта одного размера (px) могут выглядеть по-разному крупными?',
          options: [
            { id: 'a', text: 'x-height — это ширина буквы «x»; на размер не влияет' },
            { id: 'b', text: 'x-height — высота строчных букв без выносных; шрифт с большой x-height выглядит крупнее и читабельнее при том же кегле' },
            { id: 'c', text: 'x-height — расстояние между строками' },
            { id: 'd', text: 'x-height есть только у serif-шрифтов' },
          ],
          correctId: 'b',
          explanation:
            'x-height — высота строчных букв (без ascender/descender). При одинаковом размере в px шрифт с большой x-height (например Inter) выглядит крупнее и читается лучше на мелких кеглях, чем шрифт с маленькой x-height. Поэтому при подборе пар важно сопоставлять x-height.',
        },
      ],
    },
